    ...
    public class _201810211238_Criar_Approved : Migration
    {
        ...
        public override void Up()
        {
            Create.Table("Approved")
                    ...
                    .WithColumn("Parcela1").AsDateTime().Nullable()
                    .WithColumn("Parcela2").AsDateTime().Nullable()
                    .WithColumn("Parcela3").AsDateTime().Nullable()
                    .WithColumn("Parcela4").AsDateTime().Nullable()
                    .WithColumn("Parcela5").AsDateTime().Nullable()
                    .WithColumn("Parcela6").AsDateTime().Nullable()
                    .WithColumn("Parcela7").AsDateTime().Nullable()
                    .WithColumn("Parcela8").AsDateTime().Nullable()
                    .WithColumn("Parcela9").AsDateTime().Nullable()
                    .WithColumn("Parcela10").AsDateTime().Nullable()
                    .WithColumn("Parcela11").AsDateTime().Nullable()
                    .WithColumn("Parcela12").AsDateTime().Nullable()
